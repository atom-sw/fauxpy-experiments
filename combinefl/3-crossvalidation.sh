...
for (( i=0; i<$n; i++ )) do
    # For more feature.
    # SVMRank/svm_rank_learn -c 5 ../data/cross_data/$i/train.dat ../data/cross_data/$i/svmrank-model.dat &
    # For less feature.
    # SVMRank/svm_rank_learn -c 0.01 ../data/cross_data/$i/train.dat ../data/cross_data/$i/svmrank-model.dat &
