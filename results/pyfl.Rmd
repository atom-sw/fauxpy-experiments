...
p <- ggplot(joint.data, aes(x=e_inspect.SBFL, y=e_inspect.MBFL, col=project_name)) + geom_point(size=2) + facet_grid(vars(technique.SBFL), vars(technique.MBFL)) + scale_color_met_d(P.PALETTE)
```
